// Script untuk menambahkan akun admin dengan email dan password custom
import db from "../config/Database.js";
import Users from "../models/UserModel.js";
import argon2 from "argon2";

const addCustomAdminAccount = async () => {
  try {
    console.log("🔄 Memulai proses menambahkan akun admin custom...");
    ...
    const plainPassword = "admin"; // Password: admin
...
// Jalankan script
console.log("🚀 Memulai script menambahkan admin custom...");
addCustomAdminAccount(); 