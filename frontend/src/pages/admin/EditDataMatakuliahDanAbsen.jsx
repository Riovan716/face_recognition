...
export default function EditDataMatakuliahDanAbsen() {
  ...
  const confirmEdit = async () => {
    try {
      ...
      if (errorMessage.toLowerCase().includes("matakuliah sudah ada")) {
        setMsg("Nama Mata Kuliah sudah digunakan. Silakan pilih nama lain.");
      } else {
        setMsg(errorMessage);
      }
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] overflow-y-auto px-0 sm:px-0 py-0 pb-16">
      <div className="bg-white p-6 rounded-md mb-6 border-t-4 border-blue-500">
        <h1 className="text-sm font-bold text-black mb-1">Edit Matakuliah</h1>
        <div className="text-sm text-black flex items-center gap-2">
          ...
          <span className="text-black-500">●</span>
          <span className="!text-black font-medium">Edit Matakuliah</span>
        </div>
      </div>
          ...
          <div className="space-y-4 bg-gray-50 p-6 rounded-lg border border-gray-100">
            ...
            {[
              ...
              <div key={field.name} className="relative group">
                ...
                <span className="absolute top-9 left-3 text-gray-500 group-focus-within:text-blue-500 transition-colors">
                  {field.icon}
                </span>
                <input
                  type="text"
            ...
            <div className="relative group">
              ...
              <Key
                size={18}
                className="absolute top-9 left-3 text-gray-500 group-focus-within:text-blue-500 transition-colors"
              />
              <input
                type="password"
                name="password"
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-[9999] bg-black/20 backdrop-blur-sm flex justify-center items-center">
          <div className="bg-white rounded-xl p-6 w-full max-w-sm text-center shadow-xl border-t-4 border-green-500">
            ...
            <p className="text-gray-700 mb-6">Data berhasil diperbarui!</p>
            <button
              onClick={() => {
